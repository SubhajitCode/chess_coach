    ...
    <div className="w-full max-w-[500px] p-4 rounded-xl bg-gradient-to-r from-purple-950/80 to-blue-950/80 border border-purple-600/50 shadow-xl flex flex-col items-center text-center gap-2 animate-fade-in">
      ...
      <div className="flex flex-wrap items-center justify-center gap-2 mt-1">
        <button
          type="button"
          onClick={onNewGame}
          className="px-3.5 py-1.5 rounded-lg bg-emerald-600 hover:bg-emerald-500 text-white text-xs font-semibold transition shadow cursor-pointer"
        >
          Play Again
        </button>
        <button
          ...
          className="px-3.5 py-1.5 rounded-lg bg-blue-600 hover:bg-blue-500 text-white text-xs font-semibold transition shadow cursor-pointer"
        >
          👤 Analyze My Play
        </button>
        <button
          ...
          className="px-3.5 py-1.5 rounded-lg bg-purple-600 hover:bg-purple-500 text-white text-xs font-semibold transition shadow border border-purple-400/30 cursor-pointer"
        >
